...
module.exports = {
    data: {
        name: 'köpek-foto',
        description: 'Rastgele bir köpek fotoğrafı gönderir.',
    },
        ...
        try {
            ...
            if (checkData.voted === 1) {
                ...
                const embed = new MessageEmbed()
                    ...
                    .setDescription('🐶 İşte sana rastgele bir Köpek fotoğrafı:')
                    .setImage(data.message) // 'data.message' olarak güncellendi
                    .setColor('#78f060');
